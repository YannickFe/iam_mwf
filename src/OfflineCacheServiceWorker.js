 ...
 *
 * the worker needs to be initialised in the application class. See https://github.com/dieschnittstelle/org.dieschnittstelle.iam.mwf.app.sample for an example
 */
                    ...
                    sendMessageForResponse( {
                        ...
                        cache.addAll( cachedResources ).then( e => {
                            ...
                            sendMessageForResponse( {
                                ...
                                args: [ 'currentManifest', responseText ],
                            } );
                            sendMessageForResponse( {
                                func: 'showToast',
                                args: [ cachedResources.length + ' cache entries have been updated successfully.' ],
                            } );
                        } ).catch( e => {
                            ...
                            sendMessageForResponse( {
                                func: 'alert',
                                args: [ 'Error on updating cache. Check your offline.manifest entries! Error is: ' + e ],
                            } );
                        } );
                    } );
                } );
